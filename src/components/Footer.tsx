const Footer = () => {
    return (
        <div className="container-fluid footerLower">
            <div className="bg-[#f57a22] h-auto w-full flex flex-col items-center pt-6 pb-12">
                ...
                <div className="flex space-x-6 pt-4">
                    <input className="rounded px-4 outline-none" type="text" placeholder="Your Name" />
                    <input className="rounded px-4 outline-none" type="tel" minLength={11} maxLength={14} placeholder="Your Phone" />
                    <input className="rounded px-4 outline-none" type="email" placeholder="Your Email" />
                    <button type="submit" className="btn-outline ml-4 rounded-xl px-16">Get Contacted</button>
                </div>
            </div>
            <div className="fLower text-left mt-12 pl-10 pr-10">
                <div className="flex justify-center items-center gap-4">
                    <div className="flex flex-col w-1/3 gap-4">
                        <a href="#" className="max-w-[200px]">
                            <img src="https://tplinsurance.com/storage/2023/07/TPL-insurance-logo-updatenew.webp" alt="" />
                        </a>
                        <p className="text-sm">
                ...
                <div className="fLower2 flex items-center justify-between border-t border-gray-400 mt-3 pt-4">
